 ...
 * just a colocated module. The link-preview card is the charter's own
 * "Primary lockup" treatment (Logo system, 01): the flat two-comma reduction
 * — the same mark used for the favicon, since the master artwork's gradients
 * don't survive rasterisation to a fixed size either — paired with the
 * wordmark, on Content Cream. "The default in every medium."
 */
...
// Same outline as icon.svg (scripts/icons/geometry.py), traced once and
// reused rather than scaled from the master artwork — see that file for why.
const BRONZE_D =
...
// Same two cuts of Source Serif 4 the site itself loads in
// [locale]/layout.tsx, just as static TTFs (satori doesn't parse woff2).
